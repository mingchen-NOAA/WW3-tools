...
with open('evalsumconfig_summer.json') as config_file:
...
for filename in filenames:
    ...
    if all(os.path.exists(fp) for fp in file_paths):
        ...
        dfs_hs = []
        dfs_wnd = []
        suffixes = ['_gfs', '_hr1', '_hr2', '_hr3a', '_hr3b', '_hr5']
...
#        print(f"Saved merged_hs to {csv_path}")
        ...
        model_columns_hs = ['hs_gfs', 'hs_hr1', 'hs_hr2', 'hs_hr3a', 'hs_hr3b', 'hs_hr5']
        model_columns_wnd = ['wnd_gfs', 'wnd_hr1', 'wnd_hr2', 'wnd_hr3a', 'wnd_hr3b', 'wnd_hr5']

        model_labels = ['GFS', 'HR1', 'HR2', 'HR3a', 'HR3b', 'HR5']

        # Create ModelObsPlot for top 5% high HS
        mop_hs = ModelObsPlot(
            model=np.c_[merged_hs_high['hs_gfs'], merged_hs_high['hs_hr1'], merged_hs_high['hs_hr2'], merged_hs_high['hs_hr3a'], merged_hs_high['hs_hr3b'], merged_hs_high['hs_hr5']],
            obs=merged_hs_high['obs_hs'],
            axisnames=["Models", "Satellite"],
            mlabels=["GFSv16", "HR1", "HR2", "HR3a", "HR3b", "HR5"],
        ...
        mop_wnd = ModelObsPlot(
            model=np.c_[merged_wnd_high['wnd_gfs'], merged_wnd_high['wnd_hr1'], merged_wnd_high['wnd_hr2'], merged_wnd_high['wnd_hr3a'], merged_wnd_high['wnd_hr3b'], merged_wnd_high['wnd_hr5']],
        ...
        def pdf_plot(dataframe, models, ftag, flag):
            model_labels = ['GFSv16', 'HR1', 'HR2', 'HR3a', 'HR3b', 'HR5']
            colors = {
                'Satellite': 'black',
                'GFSv16': 'darkblue',
                'HR1': 'darkred',
        ...
        # Plot Hs PDF
        model_hs_columns = ['hs_gfs', 'hs_hr1', 'hs_hr2', 'hs_hr3a', 'hs_hr3b', 'hs_hr5']
        ...
        # Plot WND PDF
        model_wnd_columns = ['wnd_gfs', 'wnd_hr1', 'wnd_hr2', 'wnd_hr3a', 'wnd_hr3b', 'wnd_hr5']
        ...
        mop_hs = ModelObsPlot(
            model=np.c_[merged_hs['hs_gfs'], merged_hs['hs_hr1'], merged_hs['hs_hr2'], merged_hs['hs_hr3a'], merged_hs['hs_hr3b'], merged_hs['hs_hr5']],
        ...
        mop_wnd = ModelObsPlot(
            model=np.c_[merged_wnd['wnd_gfs'], merged_wnd['wnd_hr1'], merged_wnd['wnd_hr2'], merged_wnd['wnd_hr3a'], merged_wnd['wnd_hr3b'], merged_wnd['wnd_hr5']],
